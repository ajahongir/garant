...
function gui_input_change(e) {
	...
	if (obj.attributes['class'].value == 'img_href')        {myimgmap.areas[id].ahref   = obj.value;}
	else if (obj.attributes['class'].value == 'img_alt')    {myimgmap.areas[id].aalt    = obj.value;}
	else if (obj.attributes['class'].value == 'img_title')  {myimgmap.areas[id].atitle  = obj.value;}
	else if (obj.attributes['class'].value == 'img_target') {myimgmap.areas[id].atarget = obj.value;}
	else if (obj.attributes['class'].value == 'img_shape') {
...
function gui_addArea(id) {
	...
	var temp = '<input type="text"  name="maps['+id+'][img_id]" class="img_id" value="' + id + '" readonly="1"/>';
	//temp+= '<input type="checkbox" name="img_active" class="img_active" id="img_active_'+id+'" value="'+id+'">';
	//could be checkbox in the future
	temp+= '<input type="radio" name="maps['+id+'][img_active]" class="img_active" id="img_active_'+id+'" value="'+id+'">';
	temp+= '<select name="maps['+id+'][img_shape]" class="img_shape">';
	...
	temp+= '</select>';
	temp+= 'Coords: <input type="text" name="maps['+id+'][img_coords]" class="img_coords" value="">';
	temp+= 'Href: <input type="text" name="maps['+id+'][img_href]" class="img_href" value="">';
	temp+= 'Alt: <input type="text" name="maps['+id+'][img_alt]" class="img_alt" value="">';
	temp+= 'Target: <select name="maps['+id+'][img_target]" class="img_target">';
	temp+= '<option value=""  >&lt;not set&gt;</option>';
	temp+= '<option value="_self" selected >this window</option>';
